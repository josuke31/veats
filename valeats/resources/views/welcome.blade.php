...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class=" bg-sky-500 " style="font-family:'Gothic A1', sans-serif; ">
     <nav class="bg-transparent mt-18 ">
        <div class="container mx-auto px-6 items-center ">
            <div class="flex justify-between items-center py-4">
                <div class="text-x5 font-bold text-gray-800">
                    <a href="/">
                        <img src="{{ asset('/images/valeats-logo.png') }}" alt="Logo" class="h-24 w-auto">
                    </a>
                </div>

                <div class="hidden md:flex space-x-6 gap-x-9 mr-28 mt-9 mt">
                    ...
                    <button class="text-white hover:text-red-600 transition focus:outline-none " >
                        ...
                        @if (Route::has('login'))
                            <nav class="-mx-3 flex flex-1 ml-20">
                                @auth
                                    <a
                                        href="{{ url('/dashboard') }}"
